 ...
 * All figures are monthly. Rates current as of 2024.
...
public class PayrollCalculator {
    ...
    private static final BigDecimal NSSF_TIER1_LIMIT = new BigDecimal("7000");
    private static final BigDecimal NSSF_TIER2_LIMIT = new BigDecimal("29000");
    ...
    public BigDecimal calculatePaye(BigDecimal taxablePay) {
        ...
        // Apply personal relief — tax cannot go below zero
        return tax.subtract(PERSONAL_RELIEF).max(BigDecimal.ZERO).setScale(2, ROUND);
    }
